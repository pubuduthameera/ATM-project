 ...
 * @author User
 */
public class aaverification extends javax.swing.JFrame {

   
    public aaverification() {
        initComponents();
nametxt.setText(anotheraccount.name);
    }
    ...
    private void initComponents() {
        ...
        nobtn.setBackground(new java.awt.Color(51, 255, 0));
        ...
        yesbtn.setBackground(new java.awt.Color(51, 255, 0));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGap(138, 138, 138)
                            .addComponent(nobtn, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void nobtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nobtnActionPerformed
        anotheraccount an1=new anotheraccount();
an1.setVisible(true);
this.dispose();
    }//GEN-LAST:event_nobtnActionPerformed

    private void yesbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yesbtnActionPerformed
     oadepositfield anotherdepofileld=new oadepositfield();
anotherdepofileld.setVisible(true);
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aaverification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aaverification().setVisible(true);
            }
        });
    }
